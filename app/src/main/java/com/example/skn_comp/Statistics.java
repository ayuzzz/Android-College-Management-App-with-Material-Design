...
public class Statistics extends AppCompatActivity
{
    ...
    public static final String JSON_URL = "http://skn.16mb.com/PHP/Statistics.php";
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.gallery) {
                    Intent intent = new Intent(Statistics.this, GALLERY.class);
                    startActivity(intent);finish();

                }

                if (menuItem.getItemId() == R.id.notices) {
                    Intent intent = new Intent(Statistics.this, Notices.class);
                    startActivity(intent);finish();

                }

                if (menuItem.getItemId() == R.id.timetables) {
                    Intent intent = new Intent(Statistics.this, TimeTables.class);
                    startActivity(intent);finish();
                ...
                if (menuItem.getItemId() == R.id.results) {
                    Intent intent = new Intent(Statistics.this, Results.class);
                    startActivity(intent);finish();

                }

                if (menuItem.getItemId() == R.id.downloads) {
                    Intent intent = new Intent(Statistics.this, Downloads.class);
                ...
                if (menuItem.getItemId() == R.id.fee) {
                    Intent intent = new Intent(Statistics.this, Fee.class);
                    startActivity(intent);finish();
                ...
                if (menuItem.getItemId() == R.id.teaching) {
                    Intent intent = new Intent(Statistics.this, Teaching.class);
                    startActivity(intent);finish();
        ...
        StringRequest stringRequest = new StringRequest(JSON_URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        for(int i=0;i<500;i++)
                        {PD.show();}
                        Toast.makeText(Statistics.this,"Check your Connection...",Toast.LENGTH_LONG).show();
                        PD.dismiss();
                    }
                });
    ...
    private void showJSON(String json) {
        ...
        {
            Toast.makeText(Statistics.this,"No Items Found !!",Toast.LENGTH_LONG).show();
            PD.dismiss();
            return;
        }


        CustomList_Statistics cl = new CustomList_Statistics(this, ParseJSON2.firsts);
