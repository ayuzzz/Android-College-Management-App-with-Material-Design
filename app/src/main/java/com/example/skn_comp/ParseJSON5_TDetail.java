...
public class ParseJSON5_TDetail {
    ...
    public ParseJSON5_TDetail(String json){
        this.json = json;
    }
    ...
    protected void parseJSON(){
        ...
        try {
            ...
            fifths = new String[users.length()];
            ...
            for(int i=0;i<users.length();i++){
                ...
                fifths[i] = jo.getString(KEY_FIFTH);
            }
