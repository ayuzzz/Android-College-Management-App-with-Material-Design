...
public class CustomList_Timetables extends ArrayAdapter<String> {
    private String[] firsts;
    // private String[] seconds;
    // private String[] ages;
    private Activity context;

    public CustomList_Timetables(Activity context, String[] firsts) {
        super(context, R.layout.listview_timetables, firsts);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.listview_timetables, null, true);
