...
public class Attendance extends AppCompatActivity
{
    ...
    public static final String JSON_URL = "http://skn.16mb.com/PHP/Attendance.php";
        ...
        mNavigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if (menuItem.getItemId() == R.id.gallery) {
                    Intent intent = new Intent(Attendance.this, GALLERY.class);
                ...
                if (menuItem.getItemId() == R.id.timetables) {
                    Intent intent = new Intent(Attendance.this, TimeTables.class);
                    startActivity(intent);finish();
                ...
                if (menuItem.getItemId() == R.id.results) {
                    Intent intent = new Intent(Attendance.this, Results.class);
                    startActivity(intent);finish();

                }

                if (menuItem.getItemId() == R.id.downloads) {
                    Intent intent = new Intent(Attendance.this, Downloads.class);
                ...
                if (menuItem.getItemId() == R.id.teaching) {
                    Intent intent = new Intent(Attendance.this, Teaching.class);
                    startActivity(intent);finish();
        ...
        StringRequest stringRequest = new StringRequest(JSON_URL,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        for(int i=0;i<500;i++)
                        {PD.show();}
                        Toast.makeText(Attendance.this,"Check your Connection...",Toast.LENGTH_LONG).show();
                        PD.dismiss();
                    }
                });
    ...
    private void showJSON(String json) {
        ...
        {
            Toast.makeText(Attendance.this,"No Items Found !!",Toast.LENGTH_LONG).show();
            PD.dismiss();
            return;
        }

        CustomList_Attendance cl = new CustomList_Attendance(this, ParseJSON2.firsts);
