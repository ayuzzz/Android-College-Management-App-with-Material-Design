...
public class CustomList_Fee extends ArrayAdapter<String> {
    private String[] firsts;
    // private String[] seconds;
    // private String[] ages;
    private Activity context;

    public CustomList_Fee(Activity context, String[] firsts) {
        super(context, R.layout.listview_fee, firsts);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.listview_fee, null, true);
