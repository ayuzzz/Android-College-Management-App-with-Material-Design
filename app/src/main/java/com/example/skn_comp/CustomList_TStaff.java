...
public class CustomList_TStaff extends ArrayAdapter<String> {
    private String[] firsts;
    // private String[] seconds;
    // private String[] ages;
    private Activity context;

    public CustomList_TStaff(Activity context, String[] firsts) {
        super(context, R.layout.listview_tstaff, firsts);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.listview_tstaff, null, true);
