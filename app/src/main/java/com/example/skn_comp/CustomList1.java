...
public class CustomList1 extends ArrayAdapter<String> {
   ...
   // private String[] seconds;
    ...
    public CustomList1(Activity context, String[] firsts) {
        super(context, R.layout.list_view1, firsts);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.list_view1, null, true);
