...
public class CustomList_Results extends ArrayAdapter<String> {
    private String[] firsts;
    private String[] seconds;
    // private String[] ages;
    private Activity context;

    public CustomList_Results(Activity context, String[] firsts, String[] seconds) {
        super(context, R.layout.listview_results, firsts);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.listview_results, null, true);
