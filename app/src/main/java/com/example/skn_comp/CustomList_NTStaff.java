...
public class CustomList_NTStaff extends ArrayAdapter<String> {
    private String[] firsts;
    // private String[] seconds;
    // private String[] ages;
    private Activity context;

    public CustomList_NTStaff(Activity context, String[] firsts) {
        super(context, R.layout.listview_ntstaff, firsts);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View listViewItem = inflater.inflate(R.layout.listview_ntstaff, null, true);
